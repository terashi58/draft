...
in contexts where a \grammarterm{type-specifier} may appear\iref{temp.local}.
\end{note}
The other
...
const B &b2(a);                     // error: cannot copy-initialize \tcode{B} temporary from \tcode{A}
\end{codeblock}
\end{example}
...
names a complete class type with a member value,
